	...
	return (
		<Root>
			<div className='row' data-align='center' data-spacing='1'>
				...
				<div>
					<div className='row' data-spacing='1'>
						<Value v={resources.money.value} icon={p => <ResourceIcon {...p} name='money' />} />
						<Value v={resources.food.value} icon={p => <ResourceIcon {...p} name='food' />} />
						<Value v={resources.luxury.value} icon={p => <ResourceIcon {...p} name='luxury' />} />
						<Value v={resources.healthcare.value} icon={p => <ResourceIcon {...p} name='healthcare' />} />
						<Value v={resources.education.value} icon={p => <ResourceIcon {...p} name='education' />} />
						<Value v={resources.influence.value} icon={p => <ResourceIcon {...p} name='influence' />} />
						<div style={{ flex: '1 1 0' }} />
						<Value icon={p => <ProsperityIcon {...p} role='middleClass' />} v={prosperity} />
					</div>
					<div className='row' data-align='center' data-spacing='.5'>
						<div className='row' data-align='center' data-justify='center' style={{ width: '1rem' }}>
							<MiddleClassWorkerPlacementIcon height={1.25} color={colors.role.middleClass} />
						</div>
						<TrackCounter index={10} format='square' tracks={_.range(10, 31)} color={colors.role.middleClass} />
					</div>
					<div className='row' data-align='center' data-spacing='.5'>
						<div className='row' data-align='center' data-justify='center' style={{ width: '1rem' }}>
							<MiddleClassPopulationIcon height={1.25} color={colors.role.middleClass} />
						</div>
						<TrackCounter
							index={3}
							format='square'
			...
			<div className='row mt1' data-align='center' data-spacing='.5'>
				{[0, 1, 2].map(i =>
					market[i] ? (
						<CompanyCard key={i} format='tiny' company={{ id: market[i], workers: [], wages: defaultWages }} />
					) : (
...
}> = ({ resource, amount: value, price, prices, maxStorage }) => {
