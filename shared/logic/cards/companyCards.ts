...
export const capitalistCompanies: CompanyCard[] = [
	...
	},
	{
		...
		workers: [worker('both', 'unskilled'), worker('both', 'unskilled'), worker('both', 'unskilled')],
	},
	{
	...
	},
	{
		...
		production: 3,
		wages: { l1: 20, l2: 25, l3: 30 },
		workers: [worker('both', 'influence'), worker('both', 'unskilled'), worker('both', 'unskilled')],
	},
	{
		id: 'c-clinic-1',
		name: 'Clinic',
	...
	},
	{
		...
		wages: { l1: 25, l2: 30, l3: 35 },
		workers: [worker('both', 'luxury'), worker('both', 'unskilled'), worker('both', 'unskilled')],
	},
	{
		id: 'c-hospital-1',
		name: 'Hospital',
	...
	},
	{
		...
		productionFromAutomation: 2,
		wages: { l1: 20, l2: 30, l3: 40 },
		workers: [worker('both', 'healthcare'), worker('both', 'unskilled'), worker('both', 'unskilled')],
	},
	{
		id: 'c-supermarket-1',
		name: 'Supermarket',
	...
	},
	{
		...
		productionFromAutomation: 3,
		wages: { l1: 20, l2: 30, l3: 40 },
		workers: [worker('both', 'education'), worker('both', 'unskilled'), worker('both', 'unskilled')],
	},
	{
