...
import ResourceManager, { CapitalistMoneyResourceManager, MoneyResourceManager } from '../ResourceManager';
...
describe('CapitalistMoneyResourceManager', () => {
	...
	test('remove - loans, canTakeLoans=false', () => {
		...
		expect(() => manager.remove(10, { useCapital: true, canTakeLoans: false })).toThrow('not enough money');
	});
